...
export default function Footer() {
  return (
    <footer className="relative bg-[#41624F] text-[#FFFEF5] py-8 sm:py-12 mt-10 sm:mt-16">
      {/* Paper grain texture */}
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-4 sm:space-y-6 flex flex-col items-center">
        <p className="text-lg sm:text-xl font-serif px-2">
